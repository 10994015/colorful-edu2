...
if(isset($_FILES['imgsrc']) && $_FILES['imgsrc']!=""){
    ...
    $record_action = "新增";
    $sql_record = "INSERT INTO record (user, lastdate, type_name, action) 
                    VALUES (:record_user, :record_lastdate, :record_type_name, :record_action)";
    ...
    $sql_str = "INSERT INTO user (username, password, name, level, imgsrc) VALUES
                (:username, :password, :name, :level, :imgsrc)";
