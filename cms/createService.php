...
<body>
    ...
    <main id="createService">
        ...
        <div class="information">
            <h4>新增服務</h4>
            <form action="./chk_createService.php" method="POST">
                <label for="">
                    <p>服務項目:</p>
                    <input type="text" name="title" placeholder="服務項目..." id="title">
                </label>
                <label for="">
                    <p>服務項目說明:</p>
                    <textarea name="content" cols="30" rows="10" id="content" placeholder="服務項目說明..."></textarea>
                </label>
                <label for="">
                    <p>Icon:</p>
                    <i class="" id="iconView"></i>
                ...
                <a href="javascript:;" id="send" onclick="sendFn()">新增</a>
            </form>
        </div>
        <div id="iconModule">
            <div class="module">
