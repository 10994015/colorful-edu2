...
** $del_source 是否刪除來源圖檔
*/
function thumbnail( $src_name, $path, $dst_name, $dst_w, $dst_h, $del_source=false ){
  ...
  //如下, $src_width變數記錄$imgfileInfo[0], $src_height變數記錄$imgfileInfo[1]
  list($src_w, $src_h) = $imgfileInfo;
