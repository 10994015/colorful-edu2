...
if(isset($_FILES['imgsrc']) && $_FILES['imgsrc']!=""){
    ...
    $sql_str = "UPDATE pagebg SET imgsrc=:imgsrc,lastdate=:lastdate,user=:user,isshow=:isshow WHERE id=:id";
    ...
    echo "<script>alert('新增成功!');window.location.href = './updatePageBg.php?id=".$id."' </script>";
