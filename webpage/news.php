...
<div id="newsPage">
    <div class="newsType">
        <button class="newsTypeBtn focus">All</button>
        <button class="newsTypeBtn">Course</button>
        <button class="newsTypeBtn">Daily</button>
        <button class="newsTypeBtn">Train</button>
    </div>
